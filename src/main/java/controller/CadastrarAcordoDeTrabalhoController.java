...
public class CadastrarAcordoDeTrabalhoController {
    ...
    @FXML
    private TextArea atividadesAcordadas;
    @FXML
    private Button btnCadastrar;
    @FXML
    private ComboBox<Instituicao> comboInstituicao;

    @FXML
    private CheckBox checkSegunda;
    @FXML
    private TextField inicioSeg, saidaSeg, inicioSeg2, saidaSeg2;
    @FXML
    private CheckBox checkTerca;
    @FXML
    private TextField inicioTer, saidaTer, inicioTer2, saidaTer2;
    @FXML
    private CheckBox checkQuarta;
    @FXML
    private TextField inicioQua, saidaQua, inicioQua2, saidaQua2;
    @FXML
    private CheckBox checkQuinta;
    @FXML
    private TextField inicioQui, saidaQui, inicioQui2, saidaQui2;
    @FXML
    private CheckBox checkSexta;
    @FXML
    private TextField inicioSex, saidaSex, inicioSex2, saidaSex2;
    ...
    private void cadastrar() {
        ...
        try {
            ...
            alert(ok ? "Acordo cadastrado!"
                    : "Falha ao cadastrar. Verifique se preencheu Atividades ou consulte o log.");
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private String val(TextField tf) {
        return tf.getText().isBlank() ? "--:--" : tf.getText().trim();
    }
